...
class SimpleSellPutStrategy(QCAlgorithm):  # type: ignore
    ...
    def Initialize(self):
        ...
        # Set option filter - wider range for more opportunities
        self.option.SetFilter(-5, 5, timedelta(days=15), timedelta(days=90))
        
        # Strategy parameters - much looser criteria
        self.target_delta_min = 0.2  # Was 0.4 - much lower
        self.target_delta_max = 0.8  # Was 0.5 - much higher
        self.roll_up_threshold = 0.15  # Was 0.25 - more aggressive rolling
        self.roll_down_threshold = 0.85  # Was 0.75 - more aggressive rolling
        self.close_threshold_low = 0.05  # Was 0.1 - keep positions longer
        self.close_threshold_high = 0.95  # Was 0.9 - keep positions longer
        
        # Position tracking
        self.current_position = None
        self.last_trade_time = None
        self.min_days_between_trades = 1  # Was 5 - trade more frequently
