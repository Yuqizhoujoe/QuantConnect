...
class TechnicalIndicators:
    ...
    @staticmethod
    def find_support_resistance(prices: List[float], lookback: int = 20) -> Dict[str, Any]:
    ...
    @staticmethod
    def should_avoid_trading(market_regime: str, rsi: float, volatility_regime: str) -> bool:
...
class OptionAnalysis:
    ...
    @staticmethod
    def get_optimal_dte_range(market_regime: str, volatility_regime: str) -> Tuple[int, int]:
